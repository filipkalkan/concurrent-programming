...
public class ExampleBidirectional {
    ...
    class ClientThread extends MessagingThread<Integer> {
        ...
        public void run() {
            try {
                ...
                ft.send(14);
                System.out.println("request sent by ClientThread");
                int reply = receive();
    ...
    class FibonacciThread extends MessagingThread<Integer> {
