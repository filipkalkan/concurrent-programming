...
public class StatusWindow extends JFrame {
    ...
    private final JPanel workListPanel = new LenientPanel();
    private final JPanel progressListPanel = new LenientPanel();
    ...
    public void enableErrorChecks() {
        RepaintManager.setCurrentManager(new StrictRepaintManager());
    }

    // =======================================================================

    /** A panel that ensures revalidate() and repaint() are called as needed. */
    private class LenientPanel extends JPanel {
        @Override
